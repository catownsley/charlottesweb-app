...
Provides two threat model generation approaches:
- Deterministic: Graph-based STRIDE analysis with CWE mappings (existing)
- AI-powered: Claude API generates contextual threat narratives with
  consolidated dependency findings and compound risk analysis (new)
"""
